        ...
        <div class="flex">
            ...
            <aside class="w-64 bg-white/80 backdrop-blur-sm border-r border-white/20 shadow-lg min-h-screen">
                <nav class="p-4 space-y-1">
                    ...
                    <a href="{{ route('ekyc.index') }}"
                        class="block px-4 py-2 rounded-lg hover:bg-blue-100 hover:text-blue-700 transition-colors duration-200 {{ request()->routeIs('ekyc.index') ? 'bg-blue-100 text-blue-700 font-semibold shadow-sm' : 'text-gray-700' }}">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
