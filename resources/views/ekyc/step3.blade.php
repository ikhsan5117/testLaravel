<x-app-layout>
    ...
    <div class="max-w-x1 mx-auto mt-8 bg-white p-6 rounded-lg shadow">
        @if (session('error'))
            <div class="mb-4 text-red-600">{{ session('success') }}</div>
        @endif
        ...
        <form method="POST" action="{{ route('ekyc.step3.store') }}" enctype="multipart/form-data">
            ...
            <div class="flex justify-between items-center">
                ...
                <button type="submit"
                    class="px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded hover:from-blue-600 hover:to-purple-700">Simpan & Lanjutkan</button>
            </div>
        </form>
    </div>
</x-app-layout>
