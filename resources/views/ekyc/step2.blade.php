    ...
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow mt-8">
        ...
        <form action="{{ route('ekyc.step2.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="flex justify-between items-center mt-4">
                ...
                <button type="submit" class="px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-md hover:from-blue-600 hover:to-purple-700">Simpan & lanjut Step 3 -></button>
            </div>
        </form>
    </div>
</x-app-layout>