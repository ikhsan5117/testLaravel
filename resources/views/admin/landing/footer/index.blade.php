            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-96">
                ...
                <form method="POST" action="{{ route('admin.landing.footer.store') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="position" class="border-gray-300 rounded-md w-full" placeholder="e.g., 1, 2, 3">
                    </div>

                    <div>
                        <label class="block mb-1">Group</label>
                        <input type="text" name="group" class="border-gray-300 rounded-md w-full" placeholder="e.g., nav, contact">
                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-96">
                ...
                <form method="POST"
                    ...
                    <div>
                        ...
                        <input type="number"
                               name="position"
                               x-model.number="editData.position"
                               class="border-gray-300 rounded-md w-full" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               class="border-gray-300 rounded-md w-full" placeholder="e.g., nav, contact">
                    </div>
